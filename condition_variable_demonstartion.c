/************************************************************************
 * FILE		: condition_variable_demonstration().c
 * DESCRIPTION	: Program to demonstrate use of several pthread condition
 * 		  variables routines.
...
void* watch_count(void* t)
{
	 ...
	 * routine will automatically and atomically unlock the mutex while
	 * it waits. Also, note that if COUNT_LIMIT is reached before this 
